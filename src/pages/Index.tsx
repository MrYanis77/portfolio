        ...
        <Section id="projets">
          ...
          <div className="mt-14">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {projetsDessin.map((p, i) => (
                <div key={i} className="relative aspect-square rounded-xl overflow-hidden border border-border hover:border-primary/40 transition-all group cursor-pointer" onClick={() => setCertImage(p.image)}>
                  <img src={p.image} alt={p.title} className="h-full w-full object-cover group-hover:scale-105 transition-transform duration-500" />
                </div>
              ))}
            </div>
